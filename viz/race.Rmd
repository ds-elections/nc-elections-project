...
nc_race <- nc_race %>%
  ...
  mutate(voted = if_else(election_desc == "11/06/2012 GENERAL", true = "Voted2012",
                         false = election_lbl, missing = "null")) %>%
  mutate(voted = if_else(election_desc == "11/04/2014 GENERAL", true = "Voted2014",
                         false = voted, missing = voted)) %>%
  mutate(voted = if_else(election_desc == "11/08/2016 GENERAL", true = "Voted2016",
                         false = voted, missing = voted))

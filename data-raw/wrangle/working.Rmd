...
```{r}
setwd("data-raw/wrangle")
cces_2012 <- read_tsv("../cces/CCES12_Common_VV.tab.tsv") %>%
...
cces_2014 <- read_tsv("../cces/CCES14_Common_Content_Validated.tab.tsv") %>%
...
cces_2016 <- read_tsv("../cces/CCES2016_Common_FirstRelease.tab.tsv") %>%
  filter(inputstate == 37) %>% # 37 = North Carolina

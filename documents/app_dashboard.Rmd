...
We also made use of the [Cooperative Congressional Election Study (CCES)](http://cces.gov.harvard.edu/).
...
but still presents problems for working locally in `R`. We worked around this by using Amazon Web Service's relational database product, RDS, to create a remote PosgreSQL instance that housed the data.

...
cces_2014_sample_ge %>%
  ...
  labs(title = "2012 General Election: NC voter age distributions reported by the CCES, CPS, and voter file", x = "Age", y = "Density")
```
...
nc_2012 %>%
  ...
  labs(title = "2012 NC voter age distributions by gender, reported by the CCES, CPS, and voter file", x = "Age", y = "Density")
...
nc_2014 %>%
  ...
  scale_color_manual(name = "Data", values = lcolors) +
  scale_linetype_manual(name = "Gender", values = ltypes) +
  labs(title = "2014 NC voter age distributions by gender, reported by the CCES, CPS, and voter file", x = "Age", y = "Density")
...
nc_2016 %>%
  ...
  scale_color_manual(name = "Data", values = lcolors) +
  scale_linetype_manual(name = "Gender", values = ltypes) +
  labs(title = "2016 NC voter age distributions by gender, reported by the CCES, CPS, and voter file", x = "Age", y = "Density")
```
